package com.spidersattend.attendonb.ui.home.mainstate.viewmodel
...
import com.spidersattend.attendonb.base.SingleLiveEvent
import com.spidersattend.attendonb.network.BaseNetWorkApi
import com.spidersattend.attendonb.ui.home.HomeActivity
import com.spidersattend.attendonb.ui.home.mainstate.model.ApplyButtonState
import com.spidersattend.attendonb.ui.home.model.AttendMessage
import com.spidersattend.attendonb.ui.home.qrreader.model.AttendResponse
import com.spidersattend.attendonb.utilites.Constants
import com.spidersattend.attendonb.utilites.Constants.Companion.CHECK_STATS_TIME_OUT
import com.spidersattend.attendonb.utilites.Constants.Companion.ENDED
import com.spidersattend.attendonb.utilites.Constants.Companion.ENTER
import com.spidersattend.attendonb.utilites.Constants.Companion.OUT
import com.spidersattend.attendonb.utilites.MapUtls
...
//                                attendMessage.attendFlag= AttendMessage.AttendFlags.ENDED
    ...
    fun isCloseLocation(currentLocation: Location) {
        ...
        centralLocation.latitude = PrefUtil.getCurrentCentralLat(AttendOnBApp.app?.baseContext!!)!!
        centralLocation.longitude = PrefUtil.getCurrentCentralLng(AttendOnBApp.app?.baseContext!!)!!
