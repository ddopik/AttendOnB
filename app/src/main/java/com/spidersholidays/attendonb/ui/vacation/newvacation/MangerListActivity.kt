...
class MangerListActivity : BaseActivity() {
    ...
    private lateinit var mangerList: MutableList<User>
...
//    companion object{
//        val TAG =MangerListActivity::javaClass.name
//        lateinit var INSTANCE:MangerListActivity
//
//        fun getInstance(mangerList:MutableList<User>):MangerListActivity{
//
//             if (INSTANCE == null){
//                INSTANCE = MangerListActivity()
//                 INSTANCE.mangerList= mangerList
//            }
//            return  INSTANCE
//        }
