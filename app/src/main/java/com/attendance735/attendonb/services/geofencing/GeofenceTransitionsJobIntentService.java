...
package com.attendance735.attendonb.services.geofencing;
...
//            sendNotification(geofenceTransitionDetails);
     ...
     * If the user clicks the notification, control goes to the GeoFencingService.
     */
    private void sendNotification(String notificationDetails) {
        ...
        Intent notificationIntent = new Intent(getApplicationContext(), GeoFencingService.class);
